-- GRD production performance indexes
-- Run this once in Supabase SQL Editor. Safe to re-run.
-- Intentionally not executed from Flask/Vercel startup.
...
CREATE INDEX IF NOT EXISTS idx_product_fro_name ON product (fro, name);
