...
export function BalanceSheetPage() {
  ...
  return <div className="page">
    <ReportHeader title="Balance Sheet" subtitle="T-format view. Account heads can be mapped later." from={from} setFrom={setFrom} to={setTo} refresh={load} loading={loading}/>
    <div className="card" style={{padding:0,overflow:'hidden'}}>
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',borderBottom:'1px solid var(--border)'}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr'}}>
        <div style={{padding:18,borderRight:'1px solid var(--border)'}}>
          ...
          <Line label="Profit & Loss A/c" value={0}/>
    ...
    <div className="card" style={{marginTop:14}}>
      <h2>Accounting Heads</h2>
      <p className="muted">Head mapping is kept open for now. Later we can decide which GRD heads go under Capital, Current Liabilities, Current Assets, Fixed Assets, Stock, etc.</p>
    </div>
  </div>;
}
use client';
