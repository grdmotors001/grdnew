  ...
  return (
    <div className="grdLoginPage">
      <style>{`
        ...
        .grdVehicles{position:absolute;z-index:6;left:3vw;bottom:112px;display:flex;align-items:flex-end;gap:12px}
        .grdVehicle{width:250px;height:205px;position:relative;display:block;filter:drop-shadow(0 16px 12px #164e6a44)}
        .grdVehicle img{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;object-position:center bottom;display:block}
        .grdVehicle.green{width:235px}.grdVehicle.loader{width:270px}
        .grdCity{position:absolute;left:0;right:0;bottom:98px;height:280px;background:linear-gradient(180deg,#ffffff00,#ffffffb8 42%,#e9f7ff 100%);clip-path:polygon(0 63%,3% 53%,5% 60%,7% 45%,9% 58%,12% 40%,14% 57%,16% 47%,18% 59%,20% 37%,22% 55%,24% 45%,26% 59%,28% 32%,30% 54%,32% 42%,34% 58%,36% 36%,38% 53%,40% 45%,42% 58%,44% 34%,46% 54%,48% 41%,50% 56%,52% 30%,54% 53%,56% 42%,58% 57%,60% 35%,62% 54%,64% 43%,66% 58%,68% 33%,70% 54%,72% 40%,74% 57%,76% 35%,78% 53%,80% 44%,82% 58%,84% 37%,86% 54%,88% 42%,90% 58%,92% 34%,94% 54%,96% 44%,98% 58%,100% 45%,100% 100%,0 100%)}
        .grdRoad{position:absolute;left:-4%;right:-4%;bottom:78px;height:165px;background:linear-gradient(180deg,#dcecf1,#b7d1da);transform:perspective(300px) rotateX(8deg);border-top:5px solid #9ecbd8}
        ...
        .grdSocials{position:absolute;z-index:30;left:0;right:0;bottom:0;display:flex;align-items:center;justify-content:flex-start;gap:20px;padding:12px 5vw 11px;background:linear-gradient(90deg,#07509a,#063d78);border-top:4px solid #22a760;box-shadow:0 -8px 24px #0b4d7a22}
        .grdSocialLink{display:flex;align-items:center;gap:8px;color:#fff;text-decoration:none;font-size:10px;font-weight:800;padding:4px 0}.grdSocialIcon{width:31px;height:31px;border-radius:8px;display:grid;place-items:center;color:#fff;font-size:17px;font-weight:900;flex:0 0 31px}.grdSocialLink small{display:block;font-size:9px;font-weight:500;opacity:.92}.grdSocialLink strong{display:block;font-size:10px}
      ...
      <main className="grdHero">
        ...
        <div className="grdVehicles" aria-hidden="true">
          <div className="grdVehicle"><img src="https://davrath.com/wp-content/uploads/slider/cache/8334a677cda0ae574a40331f4d3325f4/21.png" alt="G.R.D. Motors e-rickshaw"/></div>
          <div className="grdVehicle green"><img src="https://davrath.com/wp-content/uploads/slider/cache/876e3048c8c5833bb08274aa76db12aa/31.png" alt="G.R.D. Motors e-rickshaw"/></div>
          <div className="grdVehicle loader"><img src="https://davrath.com/wp-content/uploads/slider/cache/76183185dbf7c53e2f52170bf120a8c8/davrath-number-one-e-loader-brand-india.jpg" alt="G.R.D. Motors e-loader"/></div>
        </div>
