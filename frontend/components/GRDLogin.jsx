  ...
  return (
    <main className="grdCleanLogin">
      <style>{`
        ...
        .brand{position:absolute;left:6%;top:24px;z-index:5;display:flex;align-items:center;gap:15px}.brandMark{width:54px;height:68px;position:relative}.brandMark i{position:absolute;bottom:5px;width:9px;border-radius:5px 5px 0 0;transform:skewY(-18deg)}.brandMark i:nth-child(1){height:34px;left:4px;background:#1687e8}.brandMark i:nth-child(2){height:47px;left:19px;background:#27b76c}.brandMark i:nth-child(3){height:60px;left:34px;background:#15549c}.brandMark b{position:absolute;right:0;top:0;width:18px;height:18px;border-left:7px solid #63c83d;border-top:7px solid #63c83d;transform:rotate(45deg)}.brandTitle{font-size:42px;font-weight:900;letter-spacing:2px;color:#0e4c8b}.brandSub{font-size:11px;font-weight:900;letter-spacing:1px;margin-top:1px;color:#173c64}
        ...
        @media(max-width:800px){.brand{left:6%;top:18px}.brandTitle{font-size:29px}.brandSub{font-size:8px}.tag{top:95px;font-size:9px;letter-spacing:2px}.hero{top:120px;left:6%}.hero h1{font-size:46px}.hero p{display:none}.tomorrow{display:none}.vehicles{bottom:650px;left:5%;transform:scale(.62);transform-origin:left bottom}.road{display:none}.loginCard{left:50%;right:auto;top:54%;transform:translate(-50%,-50%);width:calc(100vw - 28px);min-width:0;max-width:480px;padding:22px}.footer{height:70px;padding:0 5px;gap:0;justify-content:space-around}.social{min-width:0;width:20%;justify-content:center}.social span{display:none}.socialIcon{width:31px;height:31px}.grdCleanLogin:after{display:none}}
        @media(max-width:520px){.brand{left:5%}.brandMark{transform:scale(.75);transform-origin:left top}.brandTitle{font-size:24px;margin-left:-12px}.hero h1{font-size:39px}.vehicles{display:none}.loginCard{top:52%;padding:17px;border-radius:20px}.title{font-size:25px}}
      `}</style>

      <div className="brand">
        <div className="brandMark"><i/><i/><i/><b/></div>
        <div><div className="brandTitle">G.R.D. MOTORS</div><div className="brandSub">MANUFACTURER OF E-RICKSHAW &amp; E-CART</div></div>
      </div>
