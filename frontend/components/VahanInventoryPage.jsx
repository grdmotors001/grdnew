...
export function VahanInventoryPage(){
  ...
  const clear=()=>{setFromDate('');setToDate('');setName('');setSearch('');setTimeout(load,0)};
  ...
  return <div className="page">
    ...
    <div className="card" style={{marginBottom:14}}>
      <div className="toolbar">
        ...
        <Field label="Name Filter" value={name} onChange={setName} placeholder="Customer / Model"/>
    ...
    <div className="card">
      ...
      {!loading&&!inventory.length&&<tr><td colSpan="9" className="muted">No vehicle records found.</td></tr>}
