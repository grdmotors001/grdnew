...
export function HRAttendancePage() {
  ...
  return <div className="page">
    ...
    {tab==='employees' && <>
      ...
      <div className="card tableWrap" style={{marginTop:16}}><table className="table reportTable"><thead><tr><th>Code</th><th>Name</th><th>Department</th><th>Designation</th><th>Machine ID</th><th>Joining Date</th><th>Photo</th><th>Basic</th><th>Status</th></tr></thead><tbody>
